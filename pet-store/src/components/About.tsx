  ...
  <div className="room-section">
    ...
    <div className="text-content">
      ...
      <section className="cattery-philosophy">
        ...
        <div className="room-section">
          <div className="text-content">
          <p>私たちは、猫ちゃんを猫学的に、そして家族の一員として大切に育てていただくことを望んでおります。</p>
